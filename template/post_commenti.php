<div class="container p-0 m-0 h-100 justify-content-center" style="overflow-y:auto;">
    <div class="container-fluid pt-2">
        <div class="row bg-white mr-2 ml-2 pt-1" style="border-radius: 10px;">
            ...
            <div class="row  justify-content-center">
                ...
                <div class="col-5">
                    <div class="row">
                        <p class="m-0 user"><?php echo $templateParams["post"][0]["username"];?></p>
                    </div>
                    <div class="row">
                        <p class="m-0" style="font-size: small;"><?php if(isset($templateParmas["post"][0]["luogo"])){ echo "Luogo: ".$templateParmas["post"][0]["luogo"]; } ?></p>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div class="row bg-white mr-2 ml-2 mt-2" style="border-radius: 10px;">
            <div class="col-2 d-flex flex-column justify-content-center align-items-center"> <!--con aligin-item-center rimane sempre centrasto decidere se fissarlo al inizo riga o al centro-->
                <img src="./img/<?php echo $templateParams["post"][0]["foto_profilo"];?>" alt="Avatar" class="avatar">
            </div>
            <div class="col-8 d-flex flex-column justify-content-center align-items-center p-0">
                <input type="text" id="addANote" class="form-control" placeholder="Type comment..." />
            </div>
            <div class="col-2 d-flex flex-column justify-content-center "> <!--se metti align-item-center il tasto si ridimensione non rimane a grndezza fissa-->
                <button type="button" class="btn btn-dark btnshadow"><i
        ...
        <div class="row bg-white mr-2 ml-2 mt-2" style="border-radius: 10px;">
            <div class="col-2 d-flex flex-column justify-content-center">
                <img src="./img/<?php echo $commento['foto_profilo']; ?>" alt="Avatar"
                class="avatar">
            </div>
            <div class="col-8 d-flex flex-column justify-content-center">
                <div class="row">
                    <p class="m-0 user"><?php echo $commento['username']; ?></p>
                </div>
                <div class="row">
